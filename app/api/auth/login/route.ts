...
export async function POST(request: Request) {
  try {
    ...
    const user = { id: String(userDoc._id), name: String(userDoc.name), email: String(userDoc.email), key: `user:${String(userDoc._id)}`, emailVerified: Boolean(userDoc.emailVerified) };
